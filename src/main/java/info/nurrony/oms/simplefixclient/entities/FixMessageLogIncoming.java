...
@Getter
@Setter
@Table(name = "fix_messages_log_incoming")
public class FixMessageLogIncoming implements Serializable {
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final FixMessageLogIncoming other = (FixMessageLogIncoming) obj;
    ...
    public String toString() {
        return "MessageLogIncoming[" + "id=" + getId() + ", sendercompid='" + getSenderCompId() + "]";
    }
}
